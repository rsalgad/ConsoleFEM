...
public:
	...
	static Matrix GetTotalDisplacementNotOrganized(const Matrix* m, const StructureManager* structManager, const std::map<int, std::vector<double>>* listOfPlasticDisp, const int* DOF);
